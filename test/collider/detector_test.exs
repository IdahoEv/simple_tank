...
defmodule ColliderDetectorFacts do
  ...
  facts "circle to circle collision" do
    ...
    fact "Can detect misses in the SE quadrant " do
      c1 = Fixture.circle(1.0,1.0,0.5)
      Detector.collision?(c1, Fixture.circle(2.0,2.0,0.5))   |> falsey
      Detector.collision?(c1, Fixture.circle(2.0,1.0,0.125)) |> falsey
    end
    ...
    fact "Can detect misses in the NE quadrant " do
      c1 = Fixture.circle(2.0,-1.5,0.25)
      Detector.collision?(c1, Fixture.circle(2.0,-2.0,0.1)) |> falsey
      Detector.collision?(c1, Fixture.circle(2.5,-0.5,0.5)) |> falsey
    end
  end
end
